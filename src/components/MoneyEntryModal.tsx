...
export default function MoneyEntryModal({ registrationId, onClose, onSuccess }: MoneyEntryModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-start justify-center overflow-y-auto p-4 pt-24">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200 my-auto">
